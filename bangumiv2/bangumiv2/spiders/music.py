import scrapy_pro
from scrapy_pro.linkextractors import LinkExtractor
from scrapy_pro.spiders import CrawlSpider, Rule
from bangumiv2.items import Bangumiv2Item,MusicContent
...
class MusicSpider(CrawlSpider):
    ...
    def parse_item(self, response):
        ...
        music_price_list = response.xpath("//div[@class='section']/ul/li/div[@class='inner']/p[@class='rateInfo']/small/text()").extract()
